<template>
  ...
  <div :class="widgetClasses" class="card">
    <!--begin::Beader-->
    <div style="padding: 50px; margin-top: 30px" class="card-header border-0 py-5">
      <h3  class="card-title align-items-start flex-column">
        <span class="card-label fw-bold fs-3 mb-1">Action Needed</span>
        <span class="text-muted fw-semobold fs-7"
        style="margin-top: 20px; margin-bottom: 30px"
          >Outlines keep you and honest Indulging in the poorly driving keep structure you honest great opportunity.</span
        >
      </h3>
