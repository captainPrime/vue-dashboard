                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="symbol symbol-45px me-5">
                        <img src="../../public/media/icons/duotune/general/file.png" alt="" />
                      </div>
                  ...
                  <td>
                    <a
                      href="#"
                      class="text-dark fw-bold text-hover-primary d-block fs-6"
                      ><a :href="item.file" class="btn btn-primary">download</a></a
                    >
                  </td>
  ...
  methods: {
    async fetchEndpointData() {
      try {
        ...
        const response = await axios.get("https://dev.api.shirikihub.com/api/v1/files/");
